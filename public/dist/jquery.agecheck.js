...
(function ($) {
  $.ageCheck = function (options) {
    const settings = $.extend({
      ...
      copy: 'Este sitio web requiere que usted tenga [18] años o más para entrar. Por favor, introduzca su fecha de nacimiento en los campos de abajo para poder continuar:',
      success: null,
      successMsg: {
        header: 'Exito!',
        body: 'Bienvenido! Serás redirigido a nuestra web...'
      },
      underAgeMsg: 'Lo sentimos, no tienes edad suficiente para ingresar...',
      underAge: null,
      errorMsg: {
        invalidDay: 'Día está vacío o es inválido',
        invalidYear: 'Año está vacío o es inválido'
      },
