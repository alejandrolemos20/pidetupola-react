    ...
    return (
        ...
        <>
            {/* Contenedor del footer */}
                ...
                <footer className="flex flex-wrap-reverse justify-between items-center mt-16 pt-8 pr-3  rounded-lg shadow bg-gray-800">
                    ...
                    <div className="text-center p-4 text-white">
                        © 2022 Copyright:
                        <a className="text-white" href="/">PidetuPola.co</a>
                    </div>
